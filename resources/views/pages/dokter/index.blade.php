        ...
        <div class="card">
            <div class="row card-header">
                <div class="col-sm-2 col-12">
                    <a href="{{route('user_dokter.create')}}"><button type="button" id="buttonTambahUserDokter" class="btn btn-block btn-primary">Tambah
                        Dokter</button></a>
                </div>
            </div>
            <div class="card-body">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <form style="margin-top: 5px;display:inline-block;" action="{{route('user_dokter.destroy', $item->id)}}"
                                    method="POST">
                                    @csrf
                                    @method("DELETE")
