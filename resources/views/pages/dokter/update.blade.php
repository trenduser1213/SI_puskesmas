                    ...
                    <div class="card-body">
                        <div class="form-group">
                            ...
                            <input name="username" type="text" class="form-control" id="Username"
                                placeholder="Username" value="{{$dokter->users->username}}">
                        </div>
                        <div class="form-group">
                            <label for="Nama">Nama</label>
                            <input name="nama" type="text" class="form-control" id="Nama"
                                placeholder="Nama" value="{{$dokter->users->nama}}">
                        </div>
                        <div class="form-group">
                            <label for="nomor_telepon">Nomor Telepon</label>
                            <input name="nomor_telepon" type="text" class="form-control" id="nomor_telepon"
                                placeholder="Nomor Telepon" value="{{$dokter->users->nomor_telepon}}">
                        </div>
                        <div class="form-group">
                            <label for="email">Email</label>
                            <input name="email" type="email" class="form-control" id="email"
                                placeholder="Email" value="{{$dokter->users->email}}">
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <select name="jenis_kelamin" class="form-control">
                                <option value="P" {{ $dokter->users->jenis_kelamin  == 'P' ? 'selected' : ''}}>Perempuan</option>
                                <option value="L" {{ $dokter->users->jenis_kelamin  == 'L' ? 'selected' : ''}}>Laki-laki</option>
                            </select>
                        </div>
                        <div class="form-group">
                            ...
                            <select name="spesialis" class="form-control">
                                @foreach ($spesialis as $item)
                                    <option value="{{$item->id}}" {{ $dokter->users->user_spesialis  == $item->id ? 'selected' : ''}}>{{$item->nama}}</option>
                                @endforeach
                            </select>
                        </div>
                        <div class="form-group">
                            ...
                            <textarea name="alamat_rumah" type="text" class="form-control" id="alamat_rumah"
                                placeholder="" value="{{$dokter->users->alamat_rumah}}">{{$dokter->users->alamat_rumah}}</textarea>
                        </div>
                    </div>
