                        ...
                        <div class="card-body">
                            <div class="form-group">
                                ...
                                <input name="tanggal_pendaftaran" type="date" class="form-control"
                                    ...
                                    value="{{ $rekamedis->tanggal_pendaftaran }}">
                            </div>
                            <div class="form-group">
                            ...
                            <div class="card-body">
                                <div class="form-group">
                                    ...
                                    <input name="kode" type="text" class="form-control" id="KoderesepObat"
                                        ...
                                        value="{{ $rekamedis->resepobat ? $rekamedis->resepobat->kode : '' }}">
                                </div>
                                <div class="form-group">
                                    <label for="Judul Berita">Tanggal Resep Obat</label>
                                    <input name="tanggal_resep" type="date" class="form-control" id="resepObat"
                                        placeholder="Nama resep"
                                        value="{{ $rekamedis->resepobat ? $rekamedis->resepobat->tanggal_resep : '' }}">
                                </div>
                            </div>
                            <div class="card-footer">
                                <button type="submit"
                                    class="btn btn-primary">{{ $rekamedis->resep_obat_id ? 'Edit' : 'Tambah' }}</button>
                            </div>
                        </form>
                    </div>
                </div>
