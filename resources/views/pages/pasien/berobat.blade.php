                        ...
                        <tr>
                            <td>
                                @foreach ($jadwalSenin as $item)
                                    ...
                                    <form style="margin-top: 5px;display:inline-block;" action="{{route('pasien_mendaftar', $item->id)}}"
                                        method="GET">
                                        @csrf
                                        <button style="height: 25px;padding: 0px 11px;font-size: 15px;" type="submit" class="btn btn-success">Daftar</button>
                                    </form>
                                    <br>
                                @endforeach
                            </td>
